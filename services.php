...
$title='Our Services | Aircond Repair, Servicing, Installation &amp; Cleaning in KL & Selangor';
$desc='All our aircond services in Kuala Lumpur & Selangor: repair, servicing, installation, general and chemical cleaning, and gas top up. Same-day response, all brands, honest pricing.';
$canonical='https://shamaircond.com/services';
$jsonld='<script type="application/ld+json">{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://shamaircond.com/"},{"@type":"ListItem","position":2,"name":"Services","item":"https://shamaircond.com/services"}]}</script>';
include __DIR__.'/inc/header.php';
?>
<section class="page-hero" style="background-image:linear-gradient(135deg,rgba(14,42,87,.88) 0%,rgba(18,58,122,.82) 100%),url('https://shamaircond.com/assets/img/handy-man.webp')"><div class="wrap"><nav class="breadcrumb"><a href="/">Home</a> <span>/</span> <b>Services</b></nav><span class="ph-eyebrow">Our Services</span><h1>Aircond Service &amp; Repair in Kuala Lumpur & Selangor</h1><p>From a unit that will not cool to a brand new install, we cover every aircond service and repair need for homes and offices across Kuala Lumpur & Selangor. Pick a service below or call us for fast, honest help.</p></div></section>
