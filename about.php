  ...
  <div class="wrap">
    <div class="spec-grid">
      ...
      <div class="spec-collage reveal">
        <div class="spec-col">
          <div class="spec-photo"><img src="https://shamaircond.com/assets/img/aircond%20installation.jpg" alt="Aircond installation by Sham Aircond in Kuala Lumpur & Selangor" loading="lazy" onerror="this.parentElement.classList.add('noimg');this.remove()"></div>
        ...
        <div class="spec-col">
          ...
          <div class="spec-photo tall"><img src="https://shamaircond.com/assets/img/aircond%20service.jpg" alt="Aircond servicing and maintenance in Kuala Lumpur & Selangor" loading="lazy" onerror="this.parentElement.classList.add('noimg');this.remove()"></div>
        </div>
      </div>
    </div>
  </div>
